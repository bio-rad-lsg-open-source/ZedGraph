...
namespace ZedGraph
{
	...
	#region Properties
		...
		/// </summary>
		/// <remarks>Set this to null leave the X data values set to see PointPair.Missing
		/// </remarks>
		...
		/// </summary>
		/// <remarks>Set this to null leave the Y data values set to see PointPair.Missing
		/// </remarks>
		...
		/// </summary>
		/// <remarks>Set this to null leave the Z data values set to see PointPair.Missing
		/// </remarks>
