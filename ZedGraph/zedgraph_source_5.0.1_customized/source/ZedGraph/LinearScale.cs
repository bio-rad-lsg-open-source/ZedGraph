...
namespace ZedGraph
{
	...
	/// <version> $Revision: 4 $ $Date: 2/09/07 11:49a $ </version>
	[Serializable]
	...
	#region methods
		...
		override public void PickScale( GraphPane pane, Graphics g, float scaleFactor )
		{
			...
			// Change by BioRad 2007.02.09
			//  Commented out the forcing of scale maxim and minim to round number majorstep intervals
