...
namespace ZedGraph
{
	...
	#region Fields
		...
		/// <summary>
		/// protected field that stores a boolean value that indicates whether this
		/// CurveItem is highlighted on the graph.  Use the public property "IsHighlighted"
		...
		// biorad addition
		/// <summary>Whether to use for auto-scaling.</summary>
		protected bool _useForAutoScale = true;
		// end biorad
...
*/
		...
		public CurveItem( CurveItem rhs )
		{
			...
			_useForAutoScale = rhs._useForAutoScale;
			// end biorad
	...
	#region Properties
		...
		public Color Color
		{
			get
			{
				...
				else if ( this is FastLineItem)
					return ((FastLineItem)this).Line.Color;
				// End of BioRad addition
			...
			set 
			{
				...
				{
					((FastLineItem)this).Line.Color = value;
				}
				// End BioRad addition
				else if (this is ErrorBarItem)
		...
		public IPointPair this[int index]
		{
			...
			{
				if ( _points == null )
					return new PointPair2D( PointPair.Missing, PointPair.Missing );
				else
		...
		// Biorad addition
		/// <summary>
		/// Whether to use this curve for auto-scaling of axes.
		/// </summary>
		public bool UseForAutoScale
		{
			get { return _useForAutoScale; }
			set { _useForAutoScale = value; }
		}
		// end biorad
	...
	#region Utility Methods
		...
		{
			this.AddPoint( new PointPair2D( x, y ) );
		}
